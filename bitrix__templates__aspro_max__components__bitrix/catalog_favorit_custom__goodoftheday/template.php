	...
	<div class="content_wrapper_block <?= $templateName; ?>">
		<div>
			<div class="hot-wrapper-items">
				...
				<? endif; ?>
				<div class="items swipeignore c_<?= count($arResult["ITEMS"]); ?>">
					<? if (count($arResult["ITEMS"]) > 1) : ?>
						<div class="flexslider thmb">
							<ul class="flex-direction-nav">
								<li class="flex-nav-prev"><span class="flex-prev js-click">Previous</span></li>
								<li class="flex-nav-next"><span class="flex-next js-click">Next</span></li>
							</ul>
						</div>
					<? endif; ?>
					...
					<? foreach ($arResult["ITEMS"] as $key => $arItem) { ?>
						...
						<div class="item<?= (!$key ? ' active' : ''); ?> best_of_the_day-item np">
							...
							<div class="main_item_wrapper js-notice-block" id="<?= $this->GetEditAreaId($arItem['ID']); ?>_fav">
								<div class="inner_wrap goodoftheday_special-wrapper">
									...
									<div class="item_info">
										<div class="item_info_wrapper">
											...
											<div class="price_basket-wrapper">

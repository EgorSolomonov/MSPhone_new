...
$this->addExternalJS(SITE_TEMPLATE_PATH . "/components/bitrix/catalog.section/catalog_block_custom_bestChoice/script_carousel.js");
// Подключаю ФЭНСИ БОКС
?>
<? if ($arResult["ITEMS"]) : ?>
	<?

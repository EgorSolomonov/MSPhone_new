...
<? if ((isset($arParams["IBLOCK_ID"]) && $arParams["IBLOCK_ID"]) || $bAjaxMode) : ?>
	...
	<?
	$arGlobalFilter_giftsFor = array("PROPERTY_KATEGORII_TOVAROV_VALUE" => 'Подарки для него'); // добавил фильтр по свойству giftsFor

	if (is_array($arGlobalFilter_giftsFor) && $arGlobalFilter_giftsFor)
		$GLOBALS[$arComponentParams["FILTER_NAME"]] = $arGlobalFilter_giftsFor;
